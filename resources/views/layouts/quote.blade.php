...
<head>
    ...
    @php
        $seo ??= app(\App\Services\SeoService::class)->forQuote();
        $jsonLd ??= array_values(array_filter([
            app(\App\Services\SeoService::class)->organizationJsonLd(),
            app(\App\Services\SeoService::class)->breadcrumbJsonLd($seo->breadcrumbs),
        ]));
    @endphp
