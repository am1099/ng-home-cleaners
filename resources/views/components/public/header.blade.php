@php
    $navLinks = [
        ...
        ['label' => 'Areas', 'href' => route('areas'), 'active' => request()->routeIs(['areas', 'areas.show', 'areas.service'])],
        ['label' => 'Reviews', 'href' => route('reviews'), 'active' => request()->routeIs('reviews')],
    ...
    <div class="border-b border-border/80 bg-surface-page/95 backdrop-blur-sm">
        <x-public.container tag="div" class="flex h-[var(--height-header)] items-center justify-between gap-3 sm:gap-4">
            ...
            <div class="hidden items-center gap-3 lg:flex">
                ...
                <x-public.estimate-cta size="sm" location="header" />
            </div>
